...
from openaq.core.responses import ProvidersResponse
...
class TestProviders:
    ...
    def test_list_with_pagination(self, providers, mock_client, mock_list_response):
        mock_client._get.return_value = mock_list_response
        providers.list(page=3, limit=50)
        params = mock_client._get.call_args[1]["params"]
    ...
    def test_list_with_sorting(
        ...
        mock_client._get.return_value = mock_list_response
        providers.list(order_by="id", sort_order=sort_order)
        params = mock_client._get.call_args[1]["params"]
    ...
    def test_providers_get_throws(self, providers, value):
    ...
    def test_providers_list_throws(self, providers, parameter, value):
