...
class TestManufacturers:
    ...
    def test_list_with_pagination(self, manufacturers, mock_client, mock_list_response):
        mock_client._get.return_value = mock_list_response
        manufacturers.list(page=3, limit=50)
        params = mock_client._get.call_args[1]["params"]
    ...
    def test_list_with_sorting(
        ...
        mock_client._get.return_value = mock_list_response
        manufacturers.list(order_by="id", sort_order=sort_order)
        params = mock_client._get.call_args[1]["params"]
    ...
    def test_get_throws(self, manufacturers, value):
    ...
    def test_instruments_throws(self, manufacturers, value):
        with pytest.raises(IdentifierOutOfBoundsError):
    ...
    def test_list_throws(self, manufacturers, parameter, value):
