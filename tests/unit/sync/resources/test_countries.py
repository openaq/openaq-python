...
class TestCountries:
    ...
    def test_list_with_pagination(self, countries, mock_client, mock_list_response):
        mock_client._get.return_value = mock_list_response
        countries.list(page=3, limit=50)
        params = mock_client._get.call_args[1]["params"]
    ...
    def test_list_with_sorting(
        ...
        mock_client._get.return_value = mock_list_response
        countries.list(order_by="id", sort_order=sort_order)
        params = mock_client._get.call_args[1]["params"]
    ...
    def test_list_with_filters(
        ...
        mock_client._get.return_value = mock_list_response
        countries.list(parameters_id=parameters_id, providers_id=providers_id)
        params = mock_client._get.call_args[1]["params"]
    ...
    def test_countries_get_throws(self, countries, value):
    ...
    def test_countries_list_throws(self, countries, parameter, value):
