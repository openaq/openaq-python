...
from openaq.core.types import Data, DateData, DatetimeData, Rollup
...
class Measurements(ResourceBase):
    ...
    def list(
        ...
        Args:
            ...
            datetime_from: Starting datetime for the measurement retrieval. Can be a datetime.datetime object, or ISO-8601 formatted string. Only used with data='measurements' or data='hours'.
            datetime_to: Ending datetime for the measurement retrieval. Can be a datetime.datetime object, or ISO-8601 formatted string. Only used with data='measurements' or data='hours'.
