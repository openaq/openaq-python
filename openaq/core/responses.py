...
@dataclass(slots=True)
class InstrumentBase(_ModelBase):
...
@dataclass(slots=True)
class ManufacturerBase(_ModelBase):
...
@dataclass(slots=True)
class ParameterBase(_ModelBase):
