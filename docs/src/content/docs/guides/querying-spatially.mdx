...
coordinates of the four points that make up the bounding box in WGS84 format
(EPSG:4326). The query below is an example of how you can query locations from a
bounding box that roughly covers the City of Accra, Ghana.
